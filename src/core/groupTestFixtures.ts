import type { GroupInspectorDraft, GroupParameterDef } from './groupSchema'
...
export const VFX_EMITTER_COLOR_TOKEN =
  '_groupType&VfxEmitterDefinitionData_groupName&Emitter_idParameter&Emitter01_nameParameter&color_typeParameter&vec4{0.55,0.95,1,1}_slotParameter&output[vec4,vec4list]&input[multiplyVec4]_endParameter'

export const VFX_EMITTER_LIFETIME_TOKEN =
  '_groupType&VfxEmitterDefinitionData_groupName&Emitter_idParameter&Emitter02_nameParameter&particleLifetime_typeParameter&f32{1.15}_slotParameter&output[f32,f32range]_endParameter'

export const VFX_EMITTER_TEXTURE_TOKEN =
  '_groupType&VfxEmitterDefinitionData_groupName&Emitter_idParameter&Emitter03_nameParameter&@iconImg@texture_typeParameter&string{"ASSETS/Characters/Brand/Skins/Base/Particles/spark_soft.tex"}_slotParameter&output[Img]_endParameter'

export const VFX_EMITTER_NAME_TOKEN =
  '_groupType&VfxEmitterDefinitionDataResult_groupName&EmitterResult_idParameter&EmitterResult01_nameParameter&emitterName_typeParameter&string{"circulo_magico_sparks"}_endParameter'

export const vfxEmitterSampleParameters: GroupParameterDef[] = [
  {
...
export const vfxEmitterSampleDraft: GroupInspectorDraft = {
  ...
  entries: [
    ...
    },
    {
      ...
      slotRules: { outputs: ['Img'] },
      slotTags: [
        { direction: 'input', type: 'string', active: false },
