...
import { filterComboOptions } from '@/core/groupInspectorUi'

import styles from './GroupInspectorComboField.module.css'

type GroupInspectorComboFieldProps = {
  ariaLabel: string
  value: string
...
export function GroupInspectorComboField({
  ariaLabel,
  value,
  options,
  placeholder,
